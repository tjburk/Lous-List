...
class Course(models.Model):
    ...
    course_section = models.CharField(max_length=50, blank=True) # 3 digit section number
    subject = models.CharField(max_length=40, blank=True)    # Mnemonic of class (ex: "CS" 1010)
    catalog_number = models.CharField(max_length=40, blank=True, default="")  # Number of class (ex: CS "1010")
    description = models.CharField(max_length=500)  # Name of class
    units = models.CharField(max_length=100, blank=True)  # Number of units (string)
    component = models.CharField(max_length=100, blank=True)  # LEC,DIS,etc.
    ...
    # Meetings
    meetings_days = models.CharField(max_length=100, blank=True)  # "MoWe" "TuTh" etc.
    ...
    secondary_meetings_days = models.CharField(max_length=100, blank=True)  # "MoWe" "TuTh" etc.
